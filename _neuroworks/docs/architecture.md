...
## 4. Data pipeline — Omnisignal → ADRS → agent learning
...
flowchart LR
  ...
  OMNI -->|"provenance-tagged records<br/>(_source · _category · _acquiredAt)"| ADRS

  subgraph ADRS["🏭  ADRS pipeline (lib/adrs.ts)"]
    direction LR
