...
created: 2026-05-27T20:13:50.767Z
...
# When no expert lane fits, default to generalist Clawbot voice (custom-knowitall-when-no-expert-lane-fits-default-to-gene)

Persona-derived starter task for "Kit".

**Origin task:** As a Polymath, any-persona adapter, when no expert lane fits, default to generalist clawbot voice.
