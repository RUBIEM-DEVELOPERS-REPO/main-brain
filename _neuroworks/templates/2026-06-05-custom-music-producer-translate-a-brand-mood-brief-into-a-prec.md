...
# Translate a brand / mood brief into a precise music prompt (genre, tempo, ins… (custom-music-producer-translate-a-brand-mood-brief-into-a-prec)

Persona-derived starter task for "Melody".

**Origin task:** As a Music Producer, translate a brand / mood brief into a precise music prompt (genre, tempo, instruments, feel).
