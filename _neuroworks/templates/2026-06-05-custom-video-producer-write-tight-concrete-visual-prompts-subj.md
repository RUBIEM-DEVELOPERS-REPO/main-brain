...
# Write tight, concrete visual prompts (subject, action, setting, camera, mood) (custom-video-producer-write-tight-concrete-visual-prompts-subj)

Persona-derived starter task for "Vince".

**Origin task:** As a Video Producer, write tight, concrete visual prompts (subject, action, setting, camera, mood).
