...
# Sequence the assets — what plays when — into an assembly the customer can han… (custom-multimedia-producer-sequence-the-assets-what-plays-when-into)

Persona-derived starter task for "Milo".

**Origin task:** As a Multimedia Producer, sequence the assets — what plays when — into an assembly the customer can hand to an editor.
