...
# Write scripts for the ear — short sentences, natural rhythm, no unspoken punc… (custom-voice-producer-write-scripts-for-the-ear-short-sentence)

Persona-derived starter task for "Vera".

**Origin task:** As a Voice Producer, write scripts for the ear — short sentences, natural rhythm, no unspoken punctuation.
