...
# Match length and energy to the placement (ad, intro, hold music, podcast bed) (custom-music-producer-match-length-and-energy-to-the-placement)

Persona-derived starter task for "Melody".

**Origin task:** As a Music Producer, match length and energy to the placement (ad, intro, hold music, podcast bed).
