...
## Provenance & audit
- **Dataset id**: `reflections-2026-07-18-mrr6cv9h`
- **Source**: Intellinexus daily reflection
- **Sector**: operations
- **Published**: 2026-07-19T02:26:38.021Z
...
- **ML CSV** — `_datasets/reflections-2026-07-18-mrr6cv9h/dataset.csv`
- **Knowledge-graph JSONL** — `_datasets/reflections-2026-07-18-mrr6cv9h/graph.jsonl`
- **RAG chunks** — `_datasets/reflections-2026-07-18-mrr6cv9h/rag.md`
