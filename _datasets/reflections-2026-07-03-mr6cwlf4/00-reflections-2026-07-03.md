...
## Provenance & audit
- **Dataset id**: `reflections-2026-07-03-mr6cwlf4`
- **Source**: Intellinexus daily reflection
- **Sector**: operations
- **Published**: 2026-07-04T12:46:46.384Z
- **Batch root hash** (tamper-evident): `b067020b52f477bf1d050542ceccc7cdcce573e495ac4df121787aed81555698`
...
| Cryptographic Hashing | 3 | 3 | SHA-256 per record; batch root b067020b52f4… |
...
- **ML CSV** — `_datasets/reflections-2026-07-03-mr6cwlf4/dataset.csv`
- **Knowledge-graph JSONL** — `_datasets/reflections-2026-07-03-mr6cwlf4/graph.jsonl`
- **RAG chunks** — `_datasets/reflections-2026-07-03-mr6cwlf4/rag.md`
