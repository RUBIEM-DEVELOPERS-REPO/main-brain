...
## Provenance & audit
- **Dataset id**: `reflections-2026-07-03-mr6bk3sq`
- **Source**: Intellinexus daily reflection
- **Sector**: operations
- **Published**: 2026-07-04T12:09:04.058Z
- **Batch root hash** (tamper-evident): `f126b34ad1e1dafabeeca23b8804c8df0a78194cfa86ccca1799d9abf0277765`
...
| Cryptographic Hashing | 3 | 3 | SHA-256 per record; batch root f126b34ad1e1… |
...
- **ML CSV** — `_datasets/reflections-2026-07-03-mr6bk3sq/dataset.csv`
- **Knowledge-graph JSONL** — `_datasets/reflections-2026-07-03-mr6bk3sq/graph.jsonl`
- **RAG chunks** — `_datasets/reflections-2026-07-03-mr6bk3sq/rag.md`
