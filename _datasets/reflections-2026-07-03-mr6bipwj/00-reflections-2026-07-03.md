...
## Provenance & audit
- **Dataset id**: `reflections-2026-07-03-mr6bipwj`
- **Source**: Intellinexus daily reflection
- **Sector**: operations
- **Published**: 2026-07-04T12:07:59.395Z
- **Batch root hash** (tamper-evident): `d0a3c9a0ccd9fde7565d3cc3452ad0666e04516de17a5cc4044d099c40101e6d`
...
| Cryptographic Hashing | 3 | 3 | SHA-256 per record; batch root d0a3c9a0ccd9… |
...
- **ML CSV** — `_datasets/reflections-2026-07-03-mr6bipwj/dataset.csv`
- **Knowledge-graph JSONL** — `_datasets/reflections-2026-07-03-mr6bipwj/graph.jsonl`
- **RAG chunks** — `_datasets/reflections-2026-07-03-mr6bipwj/rag.md`
