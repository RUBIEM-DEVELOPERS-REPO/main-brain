...
## Provenance & audit
- **Dataset id**: `reflections-2026-07-03-mr6bw83l`
- **Source**: Intellinexus daily reflection
- **Sector**: operations
- **Published**: 2026-07-04T12:18:29.505Z
- **Batch root hash** (tamper-evident): `696f33c3c421551340286ecddb4d6ebd18eb235ec63f48f25603da97819b8607`
...
| Cryptographic Hashing | 3 | 3 | SHA-256 per record; batch root 696f33c3c421… |
...
- **ML CSV** — `_datasets/reflections-2026-07-03-mr6bw83l/dataset.csv`
- **Knowledge-graph JSONL** — `_datasets/reflections-2026-07-03-mr6bw83l/graph.jsonl`
- **RAG chunks** — `_datasets/reflections-2026-07-03-mr6bw83l/rag.md`
