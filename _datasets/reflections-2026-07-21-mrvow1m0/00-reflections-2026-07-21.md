# reflections-2026-07-21 — Dataset Knowledge Pack
...
## Provenance & audit
- **Dataset id**: `reflections-2026-07-21-mrvow1m0`
- **Source**: Intellinexus daily reflection
- **Sector**: operations
- **Published**: 2026-07-22T06:16:30.504Z
- **Batch root hash** (tamper-evident): `b5b4cfa42d2bf09501cf6eb8a229e88b2c1853113ca142510df5ed0cf8d4e65b`
...
| Cryptographic Hashing | 5 | 5 | SHA-256 per record; batch root b5b4cfa42d2b… |
...
- **ML CSV** — `_datasets/reflections-2026-07-21-mrvow1m0/dataset.csv`
- **Knowledge-graph JSONL** — `_datasets/reflections-2026-07-21-mrvow1m0/graph.jsonl`
- **RAG chunks** — `_datasets/reflections-2026-07-21-mrvow1m0/rag.md`
