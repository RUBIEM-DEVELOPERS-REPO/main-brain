...
## Provenance & audit
- **Dataset id**: `reflections-2026-07-03-mr6avdfg`
- **Source**: Intellinexus daily reflection
- **Sector**: operations
- **Published**: 2026-07-04T11:49:50.140Z
- **Batch root hash** (tamper-evident): `2f317823428146087efed8effaa3b1cb84ea961cdaeb692de724525e471b509d`
...
| Cryptographic Hashing | 3 | 3 | SHA-256 per record; batch root 2f3178234281… |
...
- **ML CSV** — `_datasets/reflections-2026-07-03-mr6avdfg/dataset.csv`
- **Knowledge-graph JSONL** — `_datasets/reflections-2026-07-03-mr6avdfg/graph.jsonl`
- **RAG chunks** — `_datasets/reflections-2026-07-03-mr6avdfg/rag.md`
