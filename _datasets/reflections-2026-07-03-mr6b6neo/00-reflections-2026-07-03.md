...
## Provenance & audit
- **Dataset id**: `reflections-2026-07-03-mr6b6neo`
- **Source**: Intellinexus daily reflection
- **Sector**: operations
- **Published**: 2026-07-04T11:58:36.288Z
- **Batch root hash** (tamper-evident): `a17595024a87e4c73beceff6276dad47a3e972784bbc6c7bb6460472db26f700`
...
| Cryptographic Hashing | 3 | 3 | SHA-256 per record; batch root a17595024a87… |
...
- **ML CSV** — `_datasets/reflections-2026-07-03-mr6b6neo/dataset.csv`
- **Knowledge-graph JSONL** — `_datasets/reflections-2026-07-03-mr6b6neo/graph.jsonl`
- **RAG chunks** — `_datasets/reflections-2026-07-03-mr6b6neo/rag.md`
